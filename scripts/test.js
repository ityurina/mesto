...
const createCard = ({name, link}) => {
    ...
    deleteButton.addEventListener('click', function () {
        ...
        /* const galleryPopupOpenImage = card.querySelector('elements__photo');*/
...
const galleryPopupCloseButton = galleryPopup.querySelector('.popup__close');
...
// подгружаем контент из карточки:
const loadGalleryData = () => {
    galleryPopupPhoto.value = cardNameInput.textContent;
    galleryPopupCaption.value = cardLinkInput.textContent;
}

loadGalleryData();

galleryPopupOpenImage.addEventListener('click', galleryPopupOpen);
galleryPopupCloseButton.addEventListener('click', galleryPopupClose);
*/
...
const initialCards = [
    ...
    {
        name: 'Нерха',
        link: 'https://continentestate.com/wp-content/uploads/2015/11/Nerja-1.jpg'
    }
];
const popup = document.querySelector('.popup');
const template = document.querySelector('.template__card');
...
const galleryPopupOpen = () => {
    popupOpen(galleryPopup);
    galleryPopupPhoto.src = card.querySelector('.elements__photo').src;
    galleryPopupPhoto.alt = card.querySelector('.elements__like').textContent;
    galleryPopupCaption.textContent = card.querySelector('.elements__like').textContent;
}
